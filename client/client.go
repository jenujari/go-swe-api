...
// SWEClient is a wrapper around the generated gRPC client.
type SWEClient struct {
	conn   *grpc.ClientConn
	client pb.SWEServiceClient
}
...
func NewSWEClient(address string) (*SWEClient, error) {
...
func (c *SWEClient) Close() error {
	return c.conn.Close()
}

// Ping checks the health of the gRPC server.
func (c *SWEClient) Ping(ctx context.Context) (*pb.PingResponse, error) {
...
func (c *SWEClient) GetPos(ctx context.Context, timeStr string, planetName string) (*pb.PosResponse, error) {
...
func (c *SWEClient) FindConjunction(ctx context.Context, start, end, planet1, planet2 string, orb int32, step float64) (*pb.ConjunctionResponse, error) {
